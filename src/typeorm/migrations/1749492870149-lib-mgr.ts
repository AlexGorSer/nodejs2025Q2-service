...
export class LibMgr1749492870149 implements MigrationInterface {
  name = 'LibMgr1749492870149';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "favorites_artists_artists" ("favoritesId" character varying NOT NULL, "artistsId" uuid NOT NULL, CONSTRAINT "PK_66223ae7b354407f1992d1569e5" PRIMARY KEY ("favoritesId", "artistsId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "favorites_albums_albums" ("favoritesId" character varying NOT NULL, "albumsId" uuid NOT NULL, CONSTRAINT "PK_64a7bf3ac232299b01062463fc0" PRIMARY KEY ("favoritesId", "albumsId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "favorites_tracks_tracks" ("favoritesId" character varying NOT NULL, "tracksId" uuid NOT NULL, CONSTRAINT "PK_e1d7ed5b143827263347ad6c43a" PRIMARY KEY ("favoritesId", "tracksId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites_artists_artists" ADD CONSTRAINT "FK_660eecabb197df0e6b0835554f6" FOREIGN KEY ("artistsId") REFERENCES "artists"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites_albums_albums" ADD CONSTRAINT "FK_4f68d4e307c3df157487b5f5c94" FOREIGN KEY ("albumsId") REFERENCES "albums"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites_tracks_tracks" ADD CONSTRAINT "FK_a68f39bdfc7688558ab5a2f3892" FOREIGN KEY ("tracksId") REFERENCES "tracks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
